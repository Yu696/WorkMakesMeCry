...
public class testIO {
    public static void main(String[] args) {
        ...
        Member member4=new Member("蔡依林","女","142","1556");
        Supervisor supervisor=new Supervisor("陈梓轩","男","250","1455","监管者");
        try {
            writeAMember("/dataBase/members/supervisor.Json",member4);
            List<Member> memberList=read("/dataBase/members/supervisor.Json", Member.class);
